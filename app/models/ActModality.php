 ...
 * @property ActModality $modalityParent
...
class ActModality extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'actGoalModalities' => array(self::HAS_MANY, 'ActGoalModality', 'modality_id'),
			'modalityParent' => array(self::BELONGS_TO, 'ActModality', 'modality_parent'),
			'actModalities' => array(self::HAS_MANY, 'ActModality', 'modality_parent'),
		);
	}
