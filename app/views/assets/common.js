  function delItem(it){
    ...
    function addItem(type){
        ...
        switch(type)
            {
            case 'UserClass':
                message = Yii::t('default', 'Class already exist');
                itensID = '.multItens';
            ...
            case 'ActGoalMatrix':
                itensID = '.multItens';
                message = Yii::t('default', 'Goal already exist');
             ...
             case 'ActGoalModality':
                ...
                message = Yii::t('default', 'Modality already exist');
             ...
             case 'ActGoalSkill':
                itensID = '#skillItens'; 
                message = Yii::t('default', 'Skill already exist');
            ...
            case 'ActGoalContent':
                ...
                message = Yii::t('default', 'Content already exist');
            ...
            if (flagExist == 1){
                ...
                $(itensID).append('<li><input type="hidden" value="'+valueItem+'" name="'+varname+'">'+nameItem+' - <a id="'+valueItem+'" onclick="delItem($(this))" href="javascript:void(0)">Yii::t('default', 'Remove')</a>');
            }
        }
