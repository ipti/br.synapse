...
<body id="synapse">
    ...
    ?>
    <div id="import">
        <form action="/render/importPeformance" method="POST" id="selectTxt" name="selectTxt" enctype="multipart/form-data">
            <label id="lbFileTxt" for="fileTxt"> Selecione o Arquivo de Exportação </label> <br>
