...
<body id="synapse">
    ...
    ?>
<div id="import">
    <form action="/render/importFromEduCenso" method="POST" id="selectTxt" name="selectTxt" enctype="multipart/form-data">
        <label id="lbFileTxt" for="fileTxt"> Selecione o Arquivo de Importação </label> <br>
