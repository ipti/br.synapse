...
class CobjectController extends Controller {
    ...
    public function actionIndex() {
        ...
        //var_dump($e->title);
        $dataProvider = new CActiveDataProvider('Cobject',
    ...
    public function actionAdmin() {
        $model = new Cobject('search');
        $model->unsetAttributes();  // clear any default values
        $model->validate();
        if (isset($_GET['Cobject']))
            $model->attributes = $_GET['Cobject'];
    ...
    public function loadModel($id) {
        $model = Cobject::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'cobject-form') {
