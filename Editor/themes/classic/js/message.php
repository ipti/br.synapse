MSG_REMOVE_SCREEN      = "<?php echo Yii::t('default', 'Do you really whant to remove this Screen?'); ?>";    
...
LABEL_ADD_PIECESET     = "<?php echo Yii::t('default', 'Add PieceSet'); ?>";  
LABEL_ADD_PIECE        = "<?php echo Yii::t('default', 'Add Piece'); ?>";     
LABEL_ADD_ELEMENT      = "<?php echo Yii::t('default', 'Add Element'); ?>";    
LABEL_ADD_IMAGE        = "<?php echo Yii::t('default', 'Insert Image'); ?>";       
LABEL_ADD_SOUND        = "<?php echo Yii::t('default', 'Insert Sound'); ?>";    
LABEL_ADD_TEXT         = "<?php echo Yii::t('default', 'Insert Text'); ?>";    
...
ERROR_INCOMPATIBLE_TYPE    = "<?php echo Yii::t('default', 'Incompatible file type.'); ?>";
...
//RENDER MESSAGES
INVALID_ATTRIBUTES = "<?php echo Yii::t('default', 'Invalid Attributes'); ?>";
