<div class="ibox">
    <div class="iboxHeader ">
        <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/theme_icon_user.png">
        <h4><?php echo Yii::t('default', 'User Manager') ?></h4><blockquote><?php echo Yii::t('default', 'User and other possibles configurations.') ?></blockquote>
    </div>
