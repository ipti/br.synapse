    ...
    this.buildHtml = function(t){
        switch (t){
            case 'addPage':
                ...
                var htmAddPage = '<div class="page" id="pg'+this.countPage+'">Pagina com contador:</div>';
            ...
            case 'addQuest':
                ...
                var htmAddQuest = '<div class="quest" id="'+questionID+'_q"><input type="text" class="actName" /><button class="addImage">addImage</button><button class="addSound">addSound</button>'+
